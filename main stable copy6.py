...
class HouseCalculator:
    ...
    def calc_heating(self, ambient_air_temps):
        """Calculator method for determining required heating enthalpy."""
    ...
    def calc_heating_temp_drop(self, time_step):
        """Calculator method for determining temperature drop of recirculated HTF."""
...
class SysMediator:
    ...
    def energy_balance_storage(self, solar_lift, heating_drop, ambient_temps, tstep):
    ...
    def energy_balance_house(self, weather_data):
        """Energy balance across house to calculate temperature drop of recirculated storage media."""
...
def main():
    ...
    for tstep in range(system_mediator.no_of_time_steps):
        system_mediator.energy_balance_storage(
            pvt_data.solar_temp_lift_hourly_avg, house_data.heating_temp_drop, weather_data.ambient_air_temps, tstep
        )
